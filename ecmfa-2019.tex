...
%\dk{``opposite''?} 
of \textsf{ADD}. \textsf{MOVE} indicates that matched elements differ in terms of their indexes, containing features, or containers. 
...
In this section, we present our evaluation method and discuss the result.
\subsection{Method}
\label{sec:method}
...
\vspace{-5pt}
\subsubsection{Mixed-operation Measurement}
...
\subsubsection{Homogeneous-operation Measurement}
