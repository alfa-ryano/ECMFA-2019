...
\jotdetails{
    volume=18,
    number=2,
    articleno=N, % with N the article progressive number as given in https://pad.inria.fr/p/np_MrFiqlxg8VNB1HR1
    year=2019,
    doisuffix=jot.2019.18.2.aN, % with the same N as below
    license=ccbyncnd % with L chosen from ccby, ccbynd, ccbyncnd
}
