...
\begin{algorithm}[H]
    \begin{footnotesize}
        ...
        \If{getType($feature$) \Is Attribute \And isSingleValued($feature$) \And leftValue <> rightValue \And leftIsCreated($element$)\Is false \And leftIsDeleted($element$) \Is false \And rightIsCreated($element$) \Is false \And rightIsDeleted($element$) \Is false}{
